    ...
    <div>
      <nav class="container relative mx-auto p-6">
        ...
        {/* <!-- Mobile Menu --> */}
        {
          ...
          <div
          id="menu"
          class="fixed inset-0 z-20 md:hidden flex-col items-center self-end w-full h-full m-h-screen px-6 py-1 pt-24 pb-4 tracking-widest text-white uppercase divide-y divide-gray-500 opacity-90 bg-veryDarkBlue"
        >
      ...
      <section id="tabs">
        ...
        <div class="container relative mx-auto my-6 mb-32 mt-12 px-6">
          ...
          <div id="panels" class="container mx-auto">
            ...
            {/* <!-- Panel 2 --> */}
            <div class="flex-col hidden py-5 md:flex-row md:space-x-7 panel panel-2">
              {/* <!-- Panel Image --> */}
              <div class="flex justify-center md:w-1/2">
                <img
      ...
      <footer class="py-16 bg-veryDarkBlue">
        ...
        <div class="container flex flex-col items-center justify-between mx-auto space-y-16 px-6 md:flex-row md:space-y-0">
          ...
          <div class="flex flex-col items-center justify-between space-y-8 text-lg font-light md:flex-row md:space-y-0 md:space-x-14 text-grayishBlue">
            ...
            <a href="#features" class="uppercase hover:text-softRed">
              Features
            </a>
            <a href="#download" class="uppercase hover:text-softRed">
              Download
            </a>
            <a href="#faq" class="uppercase hover:text-softRed">
              FAQ
            </a>
          </div>
